		...
		<div class="attr" :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px 0 0 0","overflow":"hidden","borderRadius":"8px","flexWrap":"wrap","background":"#fff","display":"flex","position":"relative","justifyContent":"space-between","height":"auto"}'>
			...
			<div class="info" :style='{"minHeight":"570px","padding":"0 20px 20px","margin":"0px","borderRadius":"8px","background":"#f9f9f9","width":"600px","height":"auto","order":"2"}'>
				...
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>图书分类</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.tushufenlei}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>图文位置</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.tuwenweizhi}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
				...
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
					<div class="lable" :style='{"padding":"0 10px 0 0","color":"#333","textAlign":"left","width":"130px","fontSize":"14px","lineHeight":"24px","fontWeight":"bold","height":"40px"}'>图书简介</div>
					<div  :style='{"width":"498px","padding":"0 10px","fontSize":"14px","lineHeight":"24px","color":"#666"}'>{{detail.tushujianjie}}</div>
				</div>
				<div class="item" :style='{"padding":"4px","margin":"0 0 4px 0","borderColor":"rgba(85, 180, 75,.4)","background":"none","borderWidth":"0 0 1px 0 ","display":"flex","borderStyle":"solid","justifyContent":"spaceBetween"}'>
			...
			<div class="hot" :style='{"width":"100%","margin":"10px 0 0 0","background":"none","height":"auto","order":"6"}'>
			  ...
			  <div :style='{"padding":"0","margin":"16px 0 0 0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			    <div v-for="item in hotList" :key="item" :style='{"cursor":"pointer","padding":"0","boxShadow":"4px 4px  0 rgba(138, 201, 152,.6)","margin":"0","background":"#f00","width":"23%","height":"auto"}' @click="toDetail(item)">
			      ...
			      <div :style='{"padding":"4px 0 4px 0","lineHeight":"1.2","fontSize":"14px","color":"#000","textAlign":"center","background":"#f1faf4"}'>{{item.tushufenlei}}</div>
			      <div :style='{"padding":"4px 0 4px 0","lineHeight":"1.2","fontSize":"14px","color":"#000","textAlign":"center","background":"#f1faf4"}'>{{item.tuwenweizhi}}</div>

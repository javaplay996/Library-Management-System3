...
<div :style='{"border":"2px solid #a4d9b7","padding":"20px","margin":"20px auto 0","borderRadius":"8px","flexWrap":"wrap","background":"#fff","width":"1200px","position":"relative"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="图文位置" prop="tuwenweizhi">
            <el-input v-model="ruleForm.tuwenweizhi" 
                placeholder="图文位置" clearable ></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 0px","display":"inline-block"}' label="图书简介" prop="tushujianjie">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="图书简介"

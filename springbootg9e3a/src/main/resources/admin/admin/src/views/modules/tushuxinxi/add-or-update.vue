	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="图文位置" prop="tuwenweizhi">
					<el-input v-model="ruleForm.tuwenweizhi" placeholder="图文位置" clearable  :readonly="ro.tuwenweizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="图文位置" prop="tuwenweizhi">
					<el-input v-model="ruleForm.tuwenweizhi" placeholder="图文位置" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="作者" prop="zuozhe">
					<el-input v-model="ruleForm.zuozhe" placeholder="作者" clearable  :readonly="ro.zuozhe"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else class="input" label="作者" prop="zuozhe">
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' class="textarea" v-if="type!='info'" label="图书简介" prop="tushujianjie">
					<el-input
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.tushujianjie" label="图书简介" prop="tushujianjie">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.tushujianjie}}</span>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-if="type!='info'"  label="图书详情" prop="tushuxiangqing">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0","display":"inline-block"}' v-else-if="ruleForm.tushuxiangqing" label="图书详情" prop="tushuxiangqing">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				...
				tuwenweizhi: [
					{ required: true, message: '图文位置不能为空', trigger: 'blur' },
				],
				zuozhe: [
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='tuwenweizhi'){
							this.ruleForm.tuwenweizhi = obj[o];
							this.ro.tuwenweizhi = true;
							continue;
						}
						if(o=='zuozhe'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.tushuxiangqing = this.ruleForm.tushuxiangqing.replace(reg,'../../../springbootg9e3a/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
